...
const WorkSpaceConfiguration = () => {
  ...
  const getWokSpaceConfig = () => {
    dispatch(showLoader());
    postData(AssetWokconfigGetData, { id: 1 }, getResponce);
  };
    ...
    <>
      <div className="location-set ">
        ...
        <div className="location-back-heads">
          <p>
            {findLabelText(
              'These_settings_control_how_workspaces_behave_across_the_organisation',
              'These settings control how workspaces behave across the organisation',
              'Asset_Management',
            )}
          </p>
        </div>
      ...
      <div className="allow-book">
        <div className="allow-bookset">
          <div className="allowworkspace">
            ...
            <div className="allow-booksetinput">
              <div className="form-group work-space-form number-form-group ">
                <div className="number-group number-group-info">
                  <input
                    type="text"
                    min="1"
                    max="100"
              ...
              <div className="days-unlimit-blk">
                <h5>{findLabelText('day(s)', 'day(s)', 'Asset_Management')}</h5>
                <h6>
                  0 ={' '}
        ...
        <div className="allow-bookset">
          <div className="allowworkspace">
            <h4>
              {findLabelText(
                'Allow_repeat_bookings',
                'Allow repeat bookings (shuffle)',
                'Asset_Management',
              )}
              : ​​
            </h4>
